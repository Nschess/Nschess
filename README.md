...
<!-- Navigation Button -->
<a href="#biyahero-coach" class="nav-btn">
    🚍 Biyaherong Chess Coach
</a>

<!-- Biyaherong Chess Coach Section -->
<section id="biyahero-coach" class="coach-section">
    <h2>🚍 Biyaherong Chess Coach</h2>
    <p>Learn Chess Anywhere, Anytime!</p>

    <div class="video-grid">

        <div class="video-card">
            <h3>🎥 Video 1: Chess Basics in 5 Minutes</h3>
        ...
        <div class="video-card">
            <h3>🎥 Video 5: Checkmate Patterns</h3>
            <iframe width="100%" height="200"
        ...
        <div class="video-card">
            <h3>🎥 Video 6: Opening Principles</h3>
            <iframe width="100%" height="200"
        ...
        <div class="video-card">
            <h3>🎥 Video 7: Common Beginner Mistakes</h3>
            <iframe width="100%" height="200"
